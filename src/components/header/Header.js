    ...
    <Navbar collapseOnSelect expand="xl" className="nav" variant="dark">
      ...
      <Navbar.Collapse id="responsive-navbar-nav">
        <Nav className="navbar mr-auto">
          ...
          <Nav.Link
            className="link"
            href="https://docs.google.com/document/d/1g_yUDvc9Qez3tHza2V5kCMgrhYji9XwH_h1y7u_URDQ/edit?usp=sharing"
            target="_blank"
          >
            Resume
          </Nav.Link>
        ...
        <Navbar className="navbarsocial">
          ...
          <div className="social">
            <Nav.Link
              href="https://www.linkedin.com/in/robert-richards-pt-dpt/"
              target="_blank"
            >
